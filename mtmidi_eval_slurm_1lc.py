...
if __name__ == "__main__":
    ...
    for embedding_type in args.embedding_types:
        ...
        cur_prefix = get_prefix(inversion, embedding_type)
        ...
        p_str = f"python {py_path} -ds {dataset} -ev True -et {embedding_type} -cbs {cur_cbs} -m {cur_memmap} -inv {inversion} -pf {cur_prefix} -sh {args.on_share} -nh True"
        ...
        script_str = "\n".join(slurm_strarr)
        print(f"===== EVAL | {inversion} | {embedding_type} =====")
