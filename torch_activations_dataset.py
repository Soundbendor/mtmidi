...
class STPActivationsData(torch.utils.data.Dataset):
    def __init__(self, csvfile=os.path.join('csv', 'polyrhy_split1.csv'), data_folder='jukebox_acts', set_type='train', device='cpu', num_classes = 8, classdict = None, classification = True, norm_labels = True, layer_idx=-1):
        self.device = device
